...
int main() {
	...
	qsort(avg, N, sizeof(int), compare);

	double left = ((double)(N * 15)) / 100.0;

	int standard = (int)(round(left));
	...
	answer = temp;
	answer = answer / (double)(N - standard * 2);

	int change_answer = (int)round(answer);

	printf("%d", change_answer);
